...
window.matchMedia || (window.matchMedia = function () {
    ...
    g.ns = "picturefill", function () {
        ...
        a = a.replace("vw", "%"), g.lengthEl || (g.lengthEl = b.createElement("div"), g.lengthEl.style.cssText = "border:0;display:block;font-size:1em;left:0;margin:0;padding:0;position:absolute;visibility:hidden", g.lengthEl.className = "helper-from-picturefill-js.js"), g.lengthEl.style.width = "0px";
        try {
